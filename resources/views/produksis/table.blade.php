<table class="table" id="produksis-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        {!! Form::open(['route' => ['pemesanans.produksis.pengiriman.store', $produksi->pemesanan, $produksi], 'method' => 'post']) !!} {!! Form::select('status', $status , $produksi->pengirimans->last()->status, ['class' => 'form-control']) !!} {!! Form::hidden('produksi_id',
      ...
      <td>
        ...
        <div class='btn-group'>
          ...
          <a href="{!! route('produksis.edit', [$produksi->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a> {!! Form::button('<i class="glyphicon glyphicon-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-danger
